...
function createCash() {
  if (World.frameCount % 100 == 0) {
   // Modify the positions of cash 
    var cash = createSprite(Math.round(random(66, 1299),40, 10, 10));
...
function createDiamonds() {
  if (World.frameCount % 220 == 0) {
    ...
    var diamonds = createSprite(Math.round(random(66, 1299),40, 10, 10));
...
function createJwellery() {
  if (World.frameCount % 310 == 0) {
    ...
    var jwellery = createSprite(Math.round(random(66, 1299),40, 10, 10));
...
function createSword(){
  if (World.frameCount % 430 == 0) {
    ...
    var sword = createSprite(Math.round(random(66, 744),40, 10, 10));
